...
add_action( 'genesis_meta', 'foodie_home_genesis_meta' );
/**
 ...
 * @since 1.0.1
 */
function foodie_home_genesis_meta() {
	if ( is_active_sidebar( 'home-top' ) || is_active_sidebar( 'home-middle' ) || is_active_sidebar( 'home-bottom' ) ) {
		...
		add_action( 'genesis_loop', 'foodie_home_loop_helper' );
	}
}
/**
 ...
 * @since 1.0.0
 */
function foodie_home_loop_helper() {
